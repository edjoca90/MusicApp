...
import com.example.musicapp.ui.view.navigation.albums.SavedTracksFragmentInterface

class AdapterSavedTrackList(private val savedTracksFragmentInterface: SavedTracksFragmentInterface) :
    RecyclerView.Adapter<AdapterSavedTrackList.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.buttonFavorite.setOnClickListener {
            savedTracksFragmentInterface.onClickFavourite(tracksList, tracksList.indexOf(item))
        }
    }
